...
# Windows: python3 .\generate.py -f ..\rustdesk\flutter\build\windows\runner\Debug\ -o . -e ..\rustdesk\flutter\build\windows\runner\Debug\RustScreenSaver.exe
...
if __name__ == '__main__':
    ...
    parser.add_option("-e", "--executable", dest="executable",
                      help="specify startup file in --folder, default is RustScreenSaver.exe")
    ...
    if not options.executable:
        options.executable = 'RustScreenSaver.exe'
